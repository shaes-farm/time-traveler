...
// `cache()`d per request: layouts nest ((protected) then admin/*), and each
// calls getProfile with the same userId — without this every admin request
// paid for the round trip twice.
