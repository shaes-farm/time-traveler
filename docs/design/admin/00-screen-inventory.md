...
| 12  | Timeline editor          | Create/edit form: span (TemporalInput), type, visibility, biographical subject; draft-only authoring  | #43   | [02-wireframes/12-timeline-editor.md](02-wireframes/12-timeline-editor.md)   |
