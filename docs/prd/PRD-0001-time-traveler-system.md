...
| ~~`parent_event_id`~~ | UUID          | No       | References events(id), CASCADE      | **Deprecated (#180)** — backward event-to-event nesting, retired in favor of forward `detail_timeline_id`. Tombstoned; to be dropped. |
