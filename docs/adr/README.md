...
| [0043](adr-0043-relationship-type-inverse-integrity.md)               | Type inverses: pairing RPC + no-self-inverse CHECK; symmetry columns patched as one | Accepted         | amends 0040 (type-level involution)        |
